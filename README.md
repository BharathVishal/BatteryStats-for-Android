...
### SDK Info : 
Min SDK : 16  | Target SDK : 28 | Gradle : 3.3.0
...
&nbsp;
© 2018. Developed by Bharath Vishal (https://github.com/BharathVishal). Logo designed by Mirza Zulfan(https://github.com/mirzazulfan).
Thank you. :smile:
